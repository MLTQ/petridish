...
class MnistModelConfig:
    ...
    broadcast_slots: int = 4
    broadcast_gain: float = 0.30
    broadcast_decay: float = 0.85
    fast_weight_gain: float = 0.0
    fast_weight_decay: float = 0.95
    binding_memory_gain: float = 0.0
    binding_memory_temperature: float = 0.08
    binding_token_values: int = 0
    binding_address_regularization: float = 0.0
    batch_size: int = 16
