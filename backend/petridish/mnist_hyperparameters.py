...
SPECS: dict[str, HyperparameterSpec] = {
    ...
    "axon_growth_cost": HyperparameterSpec("axon construction cost", "growth & pruning", 0, 1, 0.01),
    "axon_growth_energy_reserve": HyperparameterSpec("post-growth energy reserve", "growth & pruning", 0, 1, 0.01),
    "new_axon_initial_utility": HyperparameterSpec("new axon starting utility", "growth & pruning", 0, 0.1, 0.005),
